...
name_mat='data/1m_withN_1a/0/R1.mat';%'data/65a_1_20/20.mat';%'data/simulation1a/1a_1.mat';%'data/65a_1_20/20.mat';%'data/simulation1a/1a_1.mat';%'data/old/sim2_b_R1';%'data/65a_1_20/20.mat' %'data/simulation1a/1a_0.mat'; %'data/simulation1a/1_a_1.mat'; %'sim2_b_R0.mat';
name_hap='data/1m_withN_1a/0/nal1.hap';%'data/65a_1_20/sdhap_matlab_nal.hap';%'data/simulation1a/nal_nim1_.hap'; %'data/65a_1_20/sdhap_matlab_nal.hap';
load(name_mat) 
