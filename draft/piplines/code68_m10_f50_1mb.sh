...
{    
    mkdir ref
    # soltub_200k.fasta  solanum_1m_R3.fa  solanum.fa solanum_5m_R1.fa solanum_5m_a.fa
    cp /mnt/LTR_userdata/majid001/genomes/solanum_tuberosum/solanum_1m_R3.fa ref/ref.fasta
...
ReadGenerating()
{
    ...
    ~/Install/LRSIM/simulateLinkedReads_notRandom-m.pl -g haplogen/edited/genome.fa -p out_lrsim/sim \
     -o -x .15 -f 50 -m 10 -t .44 #-x 9.3 -f 20 -m 10 -t 66.5 #for 88.6mb
...
python3 /mnt/scratch/majid001/software/code_py/old/split_v2c.py  frag.txt pos_freebayes.txt 50
