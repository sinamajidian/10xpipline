...
hap10='/mnt/LTR_userdata/majid001/software/code_matlab/myalgorithm_franklin/compile/hap10/run_hap10.sh'
matlab_mcr='/mnt/scratch/majid001/installed/matlab_runtime/v96'
...
for (( i=(($cc_num-1)); i>=0; i--)); do  
    ...
    for ((j=1; j<=$part_num_i; j++)); do
        ...
        #$hap10 $matlab_mcr frag${i}_${j}.txt $k
